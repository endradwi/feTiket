    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans flex flex-col">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-8 py-4 bg-white border-b border-slate-100">
        ...
        <div className="hidden md:flex items-center gap-10 text-sm font-medium">
          <Link to="/" className={`${location.pathname === '/' ? 'text-[#5F2EEA] border-b-2 border-[#5F2EEA]' : 'text-muted-foreground hover:text-[#5F2EEA]'} py-1 transition-colors`}>Home</Link>
      ...
      <section className="px-8 py-20 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="bg-[#5F2EEA] rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden shadow-xl">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 max-w-2xl mx-auto relative z-10">
              ...
              <Button className="w-full md:w-auto bg-white text-[#5F2EEA] hover:bg-white/90 rounded-xl h-auto py-3.5 px-6 font-semibold shadow-lg">Subscribe Now</Button>
            </div>
            {/* decorative curves */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-muted-foreground font-medium">
                <li><Link to="#" className="hover:text-[#5F2EEA] transition-colors">Cinemas</Link></li>
                <li><Link to="/movie" className="hover:text-[#5F2EEA] transition-colors">Movies List</Link></li>
                <li><Link to="#" className="hover:text-[#5F2EEA] transition-colors">My Ticket</Link></li>
                <li><Link to="#" className="hover:text-[#5F2EEA] transition-colors">Notification</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-muted-foreground font-medium">
                <li><a href="#" className="flex items-center gap-3 hover:text-[#5F2EEA] transition-colors"><Instagram className="w-5 h-5"/> Tickitz Cinema id</a></li>
                <li><a href="#" className="flex items-center gap-3 hover:text-[#5F2EEA] transition-colors"><Twitter className="w-5 h-5"/> tickitz.id</a></li>
                <li><a href="#" className="flex items-center gap-3 hover:text-[#5F2EEA] transition-colors"><Facebook className="w-5 h-5"/> tickitz.id</a></li>
                <li><a href="#" className="flex items-center gap-3 hover:text-[#5F2EEA] transition-colors"><Youtube className="w-5 h-5"/> Tickitz Cinema id</a></li>
              </ul>
            </div>
          </div>
